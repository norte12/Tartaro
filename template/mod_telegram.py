...
title = input(G + '[+]' + C + ' Titulo del grupo : ' + W)
desc = input(G + '[+]' + C + ' Direccion del grupo : ' + W)
image = input(G + '[+]' + C + ' Direccion de la imagen (Best Size : 300x300) : ' + W)
mem_num = input(G + '[+]' + C + ' numero de miembros : ' + W)
online_num = input(G + '[+]' + C + ' numero de miembros online : ' + W)
