...
title = input(f'{G}[+] {C}Titulo del grupo : {W}')
image = input(f'{G}[+] {C}Direccion de la imagen del grupo (Best Size : 300x300): {W}')
...
redirect = input(G + '[+]' + C + ' Insertar Url de whatsapp : ' + W)
